...
"""
    # Replace the old evaluation portion
    content = content.replace("            wrapper.fit(train_loader, epochs=eps, device=device, debug_mode=False)\n            \n            metrics = compute_metrics(wrapper, dataset, eval_subset, device)", replacement)
