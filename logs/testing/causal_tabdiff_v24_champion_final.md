...
- Generated at: 2026-03-07T14:03:38.844221
- Device: cuda
- Seed: 7
...
- Name: v24_focal_hgb_champion
- Hard wins: 0/5
- Table all-win: False
- Formal gate pass: False
- Params(M): 0.025456 (acceptable)
- AvgInfer(ms/sample): 0.663346 (borderline)
- ATE_Bias: 0.012606
- Wasserstein: 0.575940
- CMD: 0.001749
- TSTR_AUC: 0.539919
- TSTR_PR_AUC: 0.033150
- TSTR_F1: 0.055437
- TSTR_F1_RealPrev: 0.053097
- TSTR_F1_FakePrev: 0.047809

## All Config Results

### v24_focal_hgb_champion

- config: use_noise_head=False, model_w=0.00, guidance=1.50, smooth=0.10, cf=0.05, outcome_w=0.35, epochs=10, diffusion_steps=35, guidance_schedule=constant, guidance_power=2.0, recon=0.03, moment=0.00
- hard_wins: 0/5
- table_all_win: False
