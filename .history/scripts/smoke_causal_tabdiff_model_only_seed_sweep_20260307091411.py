...
def evaluate_seed(seed: int):
    ...
    with torch.no_grad():
        ...
        raw_low = wrapper.model.sample_with_guidance(256, alpha_low, guidance_scale=2.0)
        raw_high = wrapper.model.sample_with_guidance(256, alpha_high, guidance_scale=2.0)
...
def main() -> None:
    ...
    print('=== CausalTabDiff model-only seed sweep ===')
