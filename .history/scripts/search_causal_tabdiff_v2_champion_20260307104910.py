...
OUTPUT_PATH = os.environ.get(
    ...
    os.path.join(PROJECT_ROOT, 'logs', 'testing', 'causal_tabdiff_v2_champion_search.md'),
)
...
def main() -> None:
    ...
    limit = int(os.environ.get('CAUSAL_TABDIFF_V2_SEARCH_LIMIT', str(len(CONFIGS))))
    configs = CONFIGS[: max(1, min(limit, len(CONFIGS)))]
