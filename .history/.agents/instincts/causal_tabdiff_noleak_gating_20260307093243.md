...
3. In the current architecture, the sample-time `50/50` blend of glue score and in-model score is more stable than either source alone.
4. Simple outcome-loss reweighting alone does **not** fix the remaining reversing seeds.
...
- therefore, blend readout is currently the safest operational choice for controlled preview runs
