...
for val in configs[ablation_type]:
    ...
    for seed in [42, 52, 62, 72, 82]:
        ...
        train_loader = get_dataloader('data/landmark_tables/unified_person_landmark_table.pkl', 'train', 2048, seed)
        val_loader = get_dataloader('data/landmark_tables/unified_person_landmark_table.pkl', 'val', 2048, seed)
        ...
        best = 0.0
        for ep in tqdm(range(20), desc=f"{ablation_type}={val} seed={seed}"):
            model.train()
